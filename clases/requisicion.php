<?php
    ...
    class requisicion{
        ...
        public function GetRequisicionesEnviadas($idusuario){
            $sql = "SELECT IdRequisicion, Fecha_Solicitud, Producto, Costo, Imagen, Detalle, AsignadaA FROM requisicion WHERE Estado = 'Enviada' AND Id_Empleado = '".$idusuario."' ORDER BY Fecha_Solicitud DESC;";
        ...
        public function GetRequisicionesEnRevision($idusuario){
            $sql = "SELECT IdRequisicion, Fecha_Solicitud, Producto, Costo, Imagen, Detalle, AsignadaA FROM requisicion WHERE Estado = 'EnRevision' AND Id_Empleado = '".$idusuario."' ORDER BY Fecha_Solicitud DESC;";
            $requisicionesEnviadasResult = $this->obj_conexion->query($sql);
        ...
        public function GetRequisicionesRechazadas($idusuario){
            $sql = "SELECT IdRequisicion, Fecha_Solicitud, Producto, Costo, Imagen, Detalle, AsignadaA FROM requisicion WHERE Estado = 'Rechazada' AND Id_Empleado = '".$idusuario."' ORDER BY Fecha_Solicitud DESC;";
            $requisicionesEnviadasResult = $this->obj_conexion->query($sql);
        ...
        public function GetRequisicionesAprobadas($idusuario){
            $sql = "SELECT IdRequisicion, Fecha_Solicitud, Producto, Costo, Imagen, Detalle, AsignadaA FROM requisicion WHERE Estado = 'Aprobada' AND Id_Empleado = '".$idusuario."' ORDER BY Fecha_Solicitud DESC;";
            $requisicionesEnviadasResult = $this->obj_conexion->query($sql);
